...
Emacs Lisp package for dynamic theme-aware color palette generation.
...
eask test ert test/brushup-test.el  # run tests
```
...
- Public symbols: `brushup-` prefix; private symbols: `brushup--` prefix
...
- Tests: `eask test ert test/brushup-test.el`
