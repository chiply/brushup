...
```sh
git clone https://github.com/chiply/brushup.git
cd brushup
...
```sh
eask test ert test/brushup-test.el
```
...
- Prefix all public symbols with `brushup-` and private symbols with
  `brushup--`.
